...
beta_intercept_summary = summarize_predictor(bym2_multicomp_summary, 'beta_intercept')
...
nyc_summary = pd.concat([beta_intercept_summary, beta_summary, sigma_summary, rho_summary])
...
* Fraser, 1951: Normal Samples With Linear Constraints and Given Variances. Canadian Journal of Mathematics, 3, 363–366. [doi:10.4153/CJM-1951-041-9](https://doi.org/10.4153/CJM-1951-041-9).
