...
[this Discourse post by Sean Pinkney](https://discourse.mc-stan.org/t/zero-sum-vector-and-normal-distribution/38296), developer of `sum_to_zero_vector`.
...
and will therefore be pathologically hard to fit.
Using a specified seed for the data-generating program avoids this problem.
:::
